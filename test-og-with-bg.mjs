...
import backgroundBase64 from './plugins/og-template/base64.js'
...
console.log('Generating OG image with background...')
...
try {
  ...
  writeFileSync('test-og-with-bg.png', pngBuffer)
  console.log('✅ PNG saved to test-og-with-bg.png')
} catch (error) {
